class Game:
    ...
    def settle(self):
        #结算阶段
        print(self.events, self.actions)
    ...
    def info(self):
        ...
        for p in self.players.keys():
            ...
            infos += str(p) + ": " + "  ".join([str(getattr(player, attr)) for attr in ["jue", "tower", "baotou", "defended_rush", "soldier", "died"]])
            infos += "\n"
        return infos
...
class Player:
    def __init__(self, uid):
        ...
        self.soldier = 0
        self.died = False
        self.actions_to_self = {"j":"Jue", "t":"ta", "by":"bingYing", "b":"bing", "bt":"baoTou", "fs":"fangShe", "fm":"fangMeng", "fg":"fangGao", "fk":"fangKan"}
    ...
    def aActions(self):
        ...
        if self.defended_rush >= 2:
            availables += self.all_actions.keys()
